...
import { IoNewspaperSharp, IoServer } from 'react-icons/io5'
import { MdArrowForward, MdAssignment, MdAssignmentInd } from 'react-icons/md'
...
function Banner() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 flex justify-center pb-1 sm:px-6 sm:pb-5 xl:px-8 z-50 max-w-full">
      <div
        className={cn('pointer-events-auto', 'bg-ai-agent rounded-xs', 'p-0.5')}
      >
        <div className="px-12 py-2.5 sm:py-3 bg-blackAlpha-600 rounded-xs m-auto">
          <p className="text-sm leading-6 text-white">
            <a
              href="https://docs.phala.network/overview/phala-network/confidential-ai-inference"
              target="_blank"
              rel="noopener noreferrer"
            >
              Build with GPU TEE &nbsp;<span aria-hidden="true">&rarr;</span>
            </a>
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      <svg
        viewBox="0 0 56 56"
        className={cn(
          'h-full untanglable bg-black-900 rounded-sm transition-colors',
          isHover && 'bg-phalaGreen-500',
        )}
      >
        <motion.path
      ...
      <svg viewBox="0 0 67 14" className="h-1/3 untanglable">
        <path
          d="M11.8857 4.96133C11.8857 8.06575 9.9414 9.85565 6.54896 9.85565H3.90017V13.6649H0.888672V0.333374H6.54896C9.9414 0.333374 11.8857 2.00944 11.8857 4.96133ZM9.02687 5.05649C9.02687 3.5712 8.07363 2.82857 6.39677 2.82857H3.90017V7.34223H6.39677C8.07363 7.34223 9.02687 6.58002 9.02687 5.05649Z"
          fill="#1A1A1A"
        />
        <path
          d="M16.6053 0.333374V6.99937H22.647V0.333374H25.6567V13.6649H22.647V9.66532H16.6053V13.6649H13.5965V0.333374H16.6053Z"
          fill="#1A1A1A"
        />
        <path
          d="M37.2171 10.9985H31.1033L30.0246 13.6667H26.9179L32.7117 0.335164H35.8184L41.517 13.6667H38.2959L37.2171 10.9985ZM36.1446 8.33036L34.1776 3.47605L32.1941 8.33214L36.1446 8.33036Z"
          fill="#1A1A1A"
        />
        <path
          d="M62.591 10.9985H56.4773L55.3985 13.6667H52.2918L58.0856 0.335164H61.1923L66.8887 13.6667H63.6676L62.591 10.9985ZM61.519 8.33036L59.5533 3.47428L57.5698 8.33036H61.519Z"
          fill="#1A1A1A"
        />
        <path
          d="M45.9046 0.333374V11.0368H51.6223V13.6649H42.8931V0.333374H45.9046Z"
          fill="#1A1A1A"
        />
      </svg>
    </Link>
...
const openedDropdownMenuAtom = atomWithReducer(
  ...
  (
    rec: Record<
      string,
      { isOpened: boolean; x: number; y: number; trigger?: string }
    >,
    action: {
      slug: string
      type: 'opened' | 'closed' | 'focus' | 'blur' | 'toggle'
      x?: number
      y?: number
    },
  ) => {
    ...
    const keys =
      slug === '' ? R.keys(rec) : R.uniq(R.concat(R.keys(rec), [slug]))
    return R.fromPairs(
      R.map((k) => {
...
const isAllDropdownMenuClosedAtom = atom((get) => {
  const curr = R.all(
    R.equals(false),
    R.map(([k, v]) => v.isOpened, R.toPairs(get(openedDropdownMenuAtom))),
  )
  return curr
})
...
function DropdownMenu({
  ...
  return (
    ...
    >
      {featured ? (
        <>
          <div className={cn('w-full flex flex-row bg-[#cdfa50] rounded-sm')}>
            <div className="w-2/5">{featured}</div>
            <ul
              className={cn(
...
function Hamburger() {
  ...
  return (
    <div
      className={cn(
        'col-span-1 col-start-2 row-start-1 xl:hidden',
        ...
        <div className={cn('flex flex-col gap-5 text-black-900')}>
          ...
          >
            <ul className={cn('flex flex-col gap-1.5 mt-2.5')}>
              ...
              >
                <p>
                  Discover how Phala's AI Agent Contract offers the essential
                  tools to develop and profit from intelligent applications.
                </p>
              </MenuItem>
              <MenuItem
                ...
                icon={
                  <img
                    src="/icons/menu-about-phala.png"
              ...
              <MenuItem
                ...
                icon={
                  <img
                    src="/icons/menu-ai-execution-layer.png"
              ...
              >
                <p>
                  Receive grants and technical guidance to bring your idea to
                  life with Phat Contract
                </p>
              </MenuItem>
            </ul>
          </AnimatedDetails>
          ...
          >
            <ul className={cn('flex flex-col gap-1.5 mt-2.5')}>
              ...
              >
                <p>
                  Take an active part in deciding the future direction of
                  off-chain compute
                </p>
              </MenuItem>
              <MenuItem
          ...
          >
            <ul className={cn('flex flex-col gap-1.5 mt-2.5')}>
              ...
              <MenuItem
                ...
                icon={
                  <img
                    src="/icons/menu-phala-ecosystem.png"
                    className={cn('h-5 w-5')}
                  />
                }
              ></MenuItem>
          ...
          >
            <ul className={cn('flex flex-col gap-1.5 mt-2.5')}>
              <MenuItem
                ...
                title="Phala Cloud"
                icon={
                  <img src="/icons/phala-cloud.png" className={cn('h-5 w-5')} />
                }
              ></MenuItem>
              <MenuItem
              ...
              <MenuItem
                ...
                title="Community"
                icon={
                  <img src="/icons/community.png" className={cn('h-5 w-5')} />
                }
              ></MenuItem>
              <MenuItem
  ...
  return (
    <li className="relative h-12 flex items-center cursor-pointer rounded-sm">
      ...
      >
        <span
          className={cn(
            'px-8 py-4 transition-all text-black-900 font-medium untanglable h-full flex items-center',
          )}
        >
          {children}
          <motion.span
    ...
    <li className={cn('py-1.5 px-2.5')}>
      {href ? (
        ...
        >
          <span
            className={cn(
              'h-8 w-8 p-1 flex flex-row justify-center items-center rounded-full bg-black-800 shrink-0',
            )}
          >
            {icon}
          </span>
...
function SiteNav() {
  ...
  useMotionValueEvent(scrollY, 'change', (latest: number) => {
    if (
      latest > 0 &&
      latest > lastScrollY &&
      latest - lastScrollY > 10 &&
      latest > window.screen.height / 2
    ) {
      setNavVisible(false)
  ...
  return (
    <>
      ...
      >
        <div className={cn('safe-viewport', 'py-6')}>
          <div
            className={cn(
          ...
          >
            ...
            <ul className="hidden xl:flex xl:items-center xl:gap-4 xl:h-16 xl:col-start-5 xl:col-span-17 3xl:col-start-6 3xl:col-span-19 row-start-1">
              ...
              <SiteNavItem dropdownTarget="ai-agent-contract">
                Phala Cloud
              </SiteNavItem>
      ...
      <DropdownMenu
        ...
        featured={
          <div
            className={cn(
              'flex flex-col justify-between w-full h-full py-7 px-5',
            )}
          >
      ...
      >
        ...
        >
          <p>
            Receive grants and technical guidance to bring your idea to life
            with Phat Contract
          </p>
        </MenuItem>
      </DropdownMenu>
      ...
      <DropdownMenu slug="network">
        <MenuItem
          ...
          title="PHA Token"
          icon={
            <img src="/icons/menu-pha-token.png" className={cn('h-5 w-5')} />
          }
        >
          <p>PHA is the native token of the Phala blockchain</p>
        </MenuItem>
        ...
        >
          <p>
            Take an active part in deciding the future direction of off-chain
            compute
          </p>
        </MenuItem>
        <MenuItem
